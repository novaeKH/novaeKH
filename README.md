...
I build end-to-end ML projects: from problem framing and data validation to model evaluation and business-oriented interpretation. I work mainly with tabular data and NLP.
...
- Selected the top 10% of clients instead of using a fixed classification threshold.
- Achieved **AP 0.530**, **ROC-AUC 0.745** and **Lift@10% 1.91** on the final period.
- Interpreted the model with permutation importance and Logistic Regression coefficients.

`Python` `Pandas` `Scikit-learn` `Machine Learning` `Model Interpretation`
